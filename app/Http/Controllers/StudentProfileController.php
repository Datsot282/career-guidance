...
class StudentProfileController extends Controller
{
    public function index() {
        $user = Auth::user();
        return view('col_student.profile', compact('user'));
    }
    public function updatestudentprofilePost(Request $request)
    {
        ...
        if ($user->save()) {
            return redirect()->route('stuprofile')->with("success", "Profile updated successfully.");
        }
        return redirect()->route('stuprofile')->with("error", "Update failed. Please try again.");
    }
