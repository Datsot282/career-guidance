...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link " href="/shc_dashboard">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="/sch_applications">
                <i class="bi bi-journal-text"></i>
                <span>Applications</span>
            </a>
        </li><!-- End Profile Page Nav -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="/sch_fuculties">
                <i class="bi bi-journal-text"></i>
                <span>Fuculties</span>
            </a>
        </li><!-- End Profile Page Nav -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="/sch_courses">
                <i class="bi bi-journal-text"></i>
                <span>Courses</span>
            </a>
        </li><!-- End Profile Page Nav -->
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="/sch_profile">
                <i class="bi bi-person"></i>
                <span>Profile</span>
            </a>
        </li>
