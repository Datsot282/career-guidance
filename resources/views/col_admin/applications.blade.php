                                        ...
                                        @else
                                            @foreach ($userData as $data)
                                                <tr>
                                                    ...
                                                    {{--                                                    <td><a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ExtralargeviewModal">View</a></td>--}}
                                                </tr>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <select class="form-select" name="application_status" id="application_status" aria-label="Default select example">
                                                                                <option class="bg-success" value="1" selected>Yes</option>
                                                                                <option class="bg-danger" value="2">No</option>
                                                                                <option class="bg-info" value="0">Hold</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row mb-3">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <select class="form-select" name="application_id" id="application_id" aria-label="Default select example" disabled>
